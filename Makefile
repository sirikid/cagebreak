...
CPPFLAGS += -DCG_HAS_XWAYLAND=$(call option,$(xwayland),1,0)
CPPFLAGS += -DCG_HAS_FANALYZE=$(call option,$(fanalyze),1,0)
...
cagebreak: workspace.o xdg_shell.o $(call option,$(xwayland),xwayland.o)
